...
describe('Pruebas en useAuth', () => {
    ...
    test('createUser exitoso', async() => {
        ...
        const newUser = { name: 'julian', email: 'julian@gmail.com'}

        mockStore.dispatch.mockReturnValue({ ok: true })

        const resp = await createUser( newUser )

        expect(mockStore.dispatch).toHaveBeenCalledWith("auth/createUser", {"email": "julian@gmail.com", "name": "julian"})
    ...
    test('Computed: authStatus, username', () => {
        ...
        expect(username.value).toBe('julian')
