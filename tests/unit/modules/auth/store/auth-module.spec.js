...
describe('Vuex: Pruebas en el auth-module', () => {
    ...
    test('Mutation: loginUser', () => {
        ...
        const payload = {
            user: { name: 'julian', email: 'julian@gmail.com '},
            idToken: 'ABC-123',
        ...
        expect(user).toEqual({ name: 'julian', email: 'julian@gmail.com '})
    ...
    test('Getters: username currenState', () => {
        ...
        expect( store.getters['auth/username'] ).toBe('julian')
    ...
    test('Actions: createUser signInUser - Crea el usuario', async() => {
        ...
        const deleteResp = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:delete?key=AIzaSyDFM62XOm9wdr-iC1yB3Qw-vP_-n5PdaEw`, {
            idToken
        })
